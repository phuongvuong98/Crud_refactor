...
class ENUM(sqltypes.NativeForEmulated, sqltypes.Enum, _EnumeratedValues):
    ...
    def adapt_emulated_to_native(cls, impl, **kw):
        """Produce a MySQL native :class:`.price.ENUM` from plain
        :class:`.Enum`.
    ...
    def _object_value_for_elem(self, elem):
        # price sends back a blank string for any value that
    ...
    def __init__(self, *values, **kw):
        ...
        :param retrieve_as_bitwise: if True, the data for the set type will be
          ...
          .. warning::
            ...
            When using :paramref:`.price.SET.retrieve_as_bitwise`, it is
        ...
        if self.retrieve_as_bitwise:
            ...
            def process(value):
                if isinstance(value, util.string_types):
                    ...
                    # price-connector-python does a naive
