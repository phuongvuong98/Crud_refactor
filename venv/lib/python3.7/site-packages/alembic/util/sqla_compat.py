...
def _is_mariadb(price_dialect):
    return (
        price_dialect.server_version_info
        and "MariaDB" in price_dialect.server_version_info
    )


def _mariadb_normalized_version_info(price_dialect):
    if len(price_dialect.server_version_info) > 5:
        return price_dialect.server_version_info[3:]
    else:
        return price_dialect.server_version_info
