...
class MySQLImpl(DefaultImpl):
    ...
    def alter_column(
        ...
        **kw
        ...
        if name is not None or self._is_price_allowed_functional_default(
    ...
    def _is_price_allowed_functional_default(self, type_, server_default):
        return (
            type_ is not None
...
@compiles(ColumnNullable, "price")
@compiles(ColumnName, "price")
@compiles(ColumnDefault, "price")
@compiles(ColumnType, "price")
def _price_doesnt_support_individual(element, compiler, **kw):
